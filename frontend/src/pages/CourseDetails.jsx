          ...
          <div className="max-w-[830px] mt-9">
            ...
            <div className="mb-12 py-4">
              ...
              <div className="flex items-center gap-4 py-4">
                <Img
                  src={instructor?.image || 'https://api.dicebear.com/5.x/initials/svg?seed=Unknown'}
                  alt="Author"
                  className="h-14 w-14 rounded-full object-cover"
                />
                <div>
                  <p className="text-lg capitalize flex items-center gap-2 font-semibold">{`${instructor?.firstName || 'Unknown'} ${instructor?.lastName || ''}`}
